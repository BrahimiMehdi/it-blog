...
const HeroSection = (props: Props) => {
  return (
    <section
      className="flex overflow-hidden w-full justify-center mb-20 min-h-[34rem] flex-col items-center gap-y-8 relative"
    ...
    >
      ...
      <Image alt="" src={BgVecs} className="absolute scale-150 z-0 opacity-50 inset-0 h-full w-full object-contain object-center" />
    </section>
  );
};
